    ...
    sidebar: [
      {
        ...
        collapsed: false,
        items: [
          { text: '🗺️ C++/Qt 桌面开发工程师面试学习路线', link: '/guide/00-roadmap' }
        ]
      },
      {
        text: '🧩 C++ 核心',
        ...
        items: [
          ...
          { text: '4. 多态与虚函数机制', link: '/guide/04-polymorphism' },
          { text: '5. virtual 关键字详解', link: '/guide/05-virtual' },
          { text: '15. 智能指针深入', link: '/guide/15-smart-pointers' },
          { text: '20. 模板与泛型编程', link: '/guide/20-templates' },
          { text: '21. C++20 新特性', link: '/guide/21-cpp20' },
          { text: '22. STL 深入', link: '/guide/22-stl' },
          { text: '23. 移动语义与完美转发', link: '/guide/23-move-semantics' },
          { text: '24. 异常处理与异常安全', link: '/guide/24-exceptions' },
          { text: '25. C++ 内存模型与原子操作', link: '/guide/25-memory-model' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '9. Qt5 与 Qt6 的区别', link: '/guide/09-qt5-qt6' },
          { text: '43. Qt Quick / QML 开发', link: '/guide/43-qt-qml' }
        ]
      },
      {
        text: '🧵 并发与线程',
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: '12. C++ 消息与通信工具', link: '/guide/12-messaging' },
          { text: '13. CRC 校验', link: '/guide/13-crc' },
          { text: '18. 串口与 USB/HID 通信', link: '/guide/18-serial-usb-hid' },
          { text: '42. 嵌入式与上位机通信协议', link: '/guide/42-embedded-protocol' }
        ]
      },
      {
        text: '🐧 Linux 与工程化',
        ...
        items: [
          ...
          { text: '17. Linux 常用命令与调试', link: '/guide/17-linux-commands' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '35. C++/Qt/Linux 高频综合题', link: '/guide/35-comprehensive' }
        ]
      },
      {
        text: '🔧 扩展领域',
        ...
        items: [
          ...
          { text: '36. GIS 基础与组件集成', link: '/guide/36-gis' },
          { text: '37. Redis 原理与应用', link: '/guide/37-redis' },
          { text: '38. 卡尔曼滤波', link: '/guide/38-kalman' },
          { text: '39. PID 控制算法', link: '/guide/39-pid' },
          { text: '40. C++ 与 C# 对比', link: '/guide/40-cpp-csharp' },
          { text: '41. Electron / 跨平台桌面技术对比', link: '/guide/41-electron' },
