...
> 📌 **本节重点**：时间/空间复杂度分析是算法题的基础，主定理和摊销分析是难点
...
> 📌 **本节重点**：快排、归并、堆排三种 O(nlogn) 排序及线性排序，必须能手写快排和归并
...
> 💡 **面试追问**：如何识别 DP 问题？状态压缩空间优化的原则是什么？
...
> 📌 **本节重点**：二分查找变体是高频考点，BST/红黑树/B+树查找场景对比
...
> 📌 **本节重点**：DP 的核心是状态定义和转移方程，背包/LCS/LIS/编辑距离是经典题型
...
> 📌 **本节重点**：BFS/DFS/Dijkstra/拓扑排序/最小生成树，掌握复杂度和适用场景
...
> 📌 **本节重点**：KMP/Rabin-Karp/滑动窗口/双指针，字符串题是算法面试高频
...
> 📌 **本节重点**：分治思想贯穿排序/查找/DP，尾递归优化和栈溢出是工程关注点
